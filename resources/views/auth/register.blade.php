            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Cargo') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="rol" type="rol" class="form-control" name="rol">
                                    <option value="Directivo">Director/a escuela</option>
                                    <option value="JefeArea">Jefe de Área Administrativa</option>
                                </select>
                                @error('rol')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
