...
<br><br>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Cargar novedades') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('liquidacion.addnovedades')}}">
                        @csrf
                        @if(session('mensaje1'))
                        ...
                        <div class="form-group row">
                            <label for="articulo" class="col-md-4 col-form-label text-md-right">{{ __('Artículo') }}</label>

                            <div class="col-md-6">
                                <input id="articulo" type="text" class="form-control @error('articulo') is-invalid @enderror" name="articulo" value="{{ old('articulo') }}" required autocomplete="articulo" autofocus>
